...
public class ProfileViewPane extends JSplitPane {
    public ProfileViewPane(TokenProfile profile) {
        super(VERTICAL_SPLIT);

        var logViewPanel = profile.getLogController().getLogViewPanel();
        var settingsPanel = profile.getSettingsController().getSettingsViewPanel();
        var tokenListenerStatePanel = profile.getTokenListenerStatePanel();
